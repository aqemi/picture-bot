/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f549079b85eb009af29f0a26d55e589a)
// Runtime types generated with workerd@1.20260114.0 2025-04-07 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ThreadDurableObject";
	}
	interface Env {
		...
		TG_TOKEN: string;
		BOT_USERNAME: string;
		FORCE_BUSINESS: string;
		ECHO: string;
		IGNORE_LIST: string;
		THREAD: DurableObjectNamespace<import("./src/index").ThreadDurableObject>;
		DB: D1Database;
		AI: Ai;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_API_KEY" | "CUSTOM_SEARCH_ENGINE_ID" | "MISTRAL_API_KEY" | "CF_ACCOUNT_ID" | "AI_GATEWAY_ID" | "NODE_ENV" | "MISTRAL_AGENT_ID" | "STICKER_SETS" | "XAI_API_KEY" | "KLIPY_API_KEY" | "TG_TOKEN" | "BOT_USERNAME" | "FORCE_BUSINESS" | "ECHO">> {}
}
